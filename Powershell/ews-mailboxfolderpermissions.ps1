...
Process {
    ...
    function Get-MailboxFolderPermission {
        ...
        try {
            ...
            $ExchangeVersion = [Microsoft.Exchange.WebServices.Data.ExchangeVersion]::Exchange2016 #VARUN

            ## Create Exchange Service Object
            $service = New-Object Microsoft.Exchange.WebServices.Data.ExchangeService($ExchangeVersion)
            $OAuthCredentials = New-Object Microsoft.Exchange.WebServices.Data.OAuthCredentials($TokenResult.AccessToken)
...
'@
            ...
            If ($Server) {
                ...
                $uri=[system.URI] "https://outlook.office365.com/ews/exchange.aspx"

                $service.Url = $uri
            }
            Else {
                #CAS URL Option 1 Autodiscover
                $service.url = "https://outlook.office365.com/ews/exchange.aspx"
